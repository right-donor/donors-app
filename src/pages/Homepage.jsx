...
/** DONOR COMPONENTS  */
import DonorHomepage from './donor/Homepage.jsx';
import Donations from './donor/DonationsPage.jsx';
            ...
            {userType &&
                (userType === 'donor' ? (
                    ...
                    <>
                        ...
                        <ListItem className={classes.listItem}>
                            <Link to={`${match.path}/doctor/perfil`} className={classes.navLink}>
                                <AccountBox />
                                Perfil
                            </Link>
                        </ListItem>
                        ...
                        <GridContainer justify='center'>
                            <GridItem xs={12} sm={12} md={12}>
                                ...
                                {!userData ? <CircularProgress color='primary' /> :
                                    ...
                                    userData.type === 'donor' ? (
                                        <Switch>
                                            <Route path={match.path} exact component={DonorHomepage} />
                                            <Route path={`${match.path}/store`} />
                                            <Route path={`${match.path}/donaciones`} component={Donations} />
                                        </Switch>
